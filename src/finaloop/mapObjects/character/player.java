...
import finaloop.mapObjects.tile.item.Item;
...
public class player extends character {
    ...
    private void detectPlaceBomb() {
        ...
        if(_input.space && game.getBombRate() > 0 && _timeBetweenPutBombs < 0) {
			...
			int xt = coord.pixelToTile(_x + _sprite.getSize() / 2);
			int yt = coord.pixelToTile( (_y + _sprite.getSize() / 2) - _sprite.getSize() ); //subtract half player height and minus 1 y position
